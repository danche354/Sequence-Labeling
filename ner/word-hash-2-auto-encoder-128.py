...
for epoch in range(nb_epoch):
    ...
    for i in range(number_of_train_batches):
        ...
        X_train_batch = prepare.prepare_auto_encoder(batch=train_batch, task='ner', gram='bi')
    ...
    for j in range(number_of_dev_batches):
        ...
        X_dev_batch = prepare.prepare_auto_encoder(batch=dev_batch, task='ner', gram='bi')
