...
for epoch in range(nb_epoch):
    ...
    for i in range(number_of_train_batches):
        ...
        embed_index, hash_index, pos, chunk, label, length, sentence = prepare.prepare_ner(batch=train_batch, gram='tri')
    ...
    for j in range(number_of_dev_batches):
        ...
        embed_index, hash_index, pos, chunk, label, length, sentence = prepare.prepare_ner(batch=dev_batch, gram='tri')
