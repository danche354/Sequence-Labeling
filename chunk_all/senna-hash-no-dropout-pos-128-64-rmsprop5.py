...
for epoch in range(nb_epoch):
    ...
    for i in range(number_of_train_batches):
        ...
        embed_index, hash_index, pos, label, length, sentence = prepare.prepare_chunk(batch=train_batch, gram='tri', chunk_type="ALL")
    ...
    for j in range(number_of_dev_batches):
        ...
        embed_index, hash_index, pos, label, length, sentence = prepare.prepare_chunk(batch=dev_batch, gram='tri', chunk_type="ALL")
